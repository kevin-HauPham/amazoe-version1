            ...
            <div class="cart-item-details-grid">
              ...
              <div class="cart-item-details">
                ...
                <div class="product-price">
                  ${(productInCart.priceCents/100).toFixed(2)}
                </div>
                <div class="product-quantity">
                  ...
                  <span class="delete-quantity-link link-primary js-delete-link" data-product-id = ${productInCart.id}>
                    Delete
                  </span>
                </div>
              </div>
              ...
              <div class="delivery-options">
                ...
                <div class="delivery-option">
                  <input type="radio" checked="" class="delivery-option-input" name="${productInCart.id}">
                  <div>
                ...
                <div class="delivery-option">
                  <input type="radio" class="delivery-option-input" name="d${productInCart.id}">
                  <div>
                    <div class="delivery-option-date">
                      Wednesday, June 15
                    </div>
                ...
                <div class="delivery-option">
                  <input type="radio" class="delivery-option-input" name="${productInCart.id}">
                  <div>
                    <div class="delivery-option-date">
                      Monday, June 13
                    </div>
...
document.querySelectorAll('.js-delete-link').forEach((link) => {
    link.addEventListener('click', () => {
        ...
        const container = document.querySelector(`.js-cart-item-container-${productIdToRemove}`);
        container.remove();
    })
})
